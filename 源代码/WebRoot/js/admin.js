		       ...
		       text: "预约献血管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "UserOrder/userOrder_add.jsp"
			    	   	},
			    		{
			    	   		text: "预约献血管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "UserOrder/userOrder_query_result.jsp"
			    	    },
			    	    {
			    		    text: "添加预约状态",
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "OrderState/orderState_add.jsp"
			    	   	},
			    		{
			    	   		text: "预约状态管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "OrderState/orderState_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "献血化验管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "BloodTest/bloodTest_add.jsp"
			    	   	},
			    		{
			    	   		text: "献血化验管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "BloodTest/bloodTest_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "血液捐献管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "BloodDonate/bloodDonate_add.jsp"
			    	   	},
			    		{
			    	   		text: "血液捐献管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "BloodDonate/bloodDonate_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "留言管理",
