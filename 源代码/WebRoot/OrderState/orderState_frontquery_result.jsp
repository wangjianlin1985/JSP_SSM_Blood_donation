		...
		<div class="col-md-12 wow fadeInDown" data-wow-duration="0.5s">
			<div>
				...
				<ul class="nav nav-tabs" role="tablist">
			    	...
			    	<li role="presentation" class="active"><a href="#orderStateListPanel" aria-controls="orderStateListPanel" role="tab" data-toggle="tab">预约状态列表</a></li>
			    	<li role="presentation" ><a href="<%=basePath %>OrderState/orderState_frontAdd.jsp" style="display:none;">添加预约状态</a></li>
				</ul>
			  	<!-- Tab panes -->
				    				...
				    				<table class="table table-condensed table-hover">
				    					...
				    					<% 
				    	            		...
				    	            		for(int i=0;i<orderStateList.size();i++) {
					    	            		...
					    	            		OrderState orderState = orderStateList.get(i); //获取到预约状态对象
 										%>
 										<tr>
 											<td><%=currentIndex %></td>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><i class="fa fa-edit"></i>&nbsp;预约状态信息编辑</h4>
      </div>
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
			 <label for="orderState_stateId_edit" class="col-md-3 text-right">状态id:</label>
			 <div class="col-md-9"> 
			 	<input type="text" id="orderState_stateId_edit" name="orderState.stateId" class="form-control" placeholder="请输入状态id" readOnly>
			 </div>
		  </div> 
		  <div class="form-group">
		  	 <label for="orderState_stateName_edit" class="col-md-3 text-right">状态名称:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="orderState_stateName_edit" name="orderState.stateName" class="form-control" placeholder="请输入状态名称">
			 </div>
		  </div>
		</form> 
