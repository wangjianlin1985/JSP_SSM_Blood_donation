		...
		<div class="col-md-12 wow fadeInUp" data-wow-duration="0.5s">
			<div>
				...
				<ul class="nav nav-tabs" role="tablist">
			    	<li role="presentation" ><a href="<%=basePath %>Notice/frontlist">最新通知列表</a></li>
			    	<li role="presentation" class="active"><a href="#noticeAdd" aria-controls="noticeAdd" role="tab" data-toggle="tab">添加最新通知</a></li>
				</ul>
				<!-- Tab panes -->
