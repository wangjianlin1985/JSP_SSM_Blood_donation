		...
		<div class="col-md-9 wow fadeInDown" data-wow-duration="0.5s">
			<div>
				...
				<ul class="nav nav-tabs" role="tablist">
			    	...
			    	<li role="presentation" class="active"><a href="#noticeListPanel" aria-controls="noticeListPanel" role="tab" data-toggle="tab">最新通知列表</a></li>
			    	<li role="presentation" ><a href="<%=basePath %>Notice/notice_frontAdd.jsp" style="display:none;">添加最新通知</a></li>
				</ul>
			  	<!-- Tab panes -->
				    				...
				    				<table class="table table-condensed table-hover">
				    					...
				    					<% 
				    	            		...
				    	            		for(int i=0;i<noticeList.size();i++) {
					    	            		...
					    	            		Notice notice = noticeList.get(i); //获取到最新通知对象
 										%>
 										<tr>
 											<td><%=currentIndex %></td>
  ...
  <div class="modal-dialog" style="width:900px;" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><i class="fa fa-edit"></i>&nbsp;最新通知信息编辑</h4>
      </div>
