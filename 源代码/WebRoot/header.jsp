...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.jsp" class="navbar-brand">基于web献血网</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <!-- 
                 ...
                 <li><a href="<%=basePath %>OrderState/frontlist">预约状态</a></li>-->
                <li><a href="<%=basePath %>UserOrder/frontlist">预约献血</a></li> 
                <li><a href="<%=basePath %>BloodTest/frontlist">献血化验</a></li>
                <li><a href="<%=basePath %>BloodDonate/frontlist">血液捐献</a></li>
                <li><a href="<%=basePath %>Leaveword/frontlist">留言</a></li>
                <li><a href="<%=basePath %>Notice/frontlist">最新通知</a></li>
             ...
             <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        ...
                        <li><a href="<%=basePath %>UserOrder/userOrder_frontUserAdd.jsp"><span class="glyphicon glyphicon-heart"></span>&nbsp;&nbsp;我要预约</a></li>
                        <li><a href="<%=basePath %>UserOrder/frontUserlist"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;我的预约记录</a></li>
                        <li><a href="<%=basePath %>BloodTest/frontUserlist"><span class="glyphicon glyphicon-cog"></span>&nbsp;&nbsp;我的化验</a></li>
                        <li><a href="<%=basePath %>BloodDonate/frontUserlist"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;我的献血记录</a></li>
